...
If the folder inside ProgramData or Intel is hidden, we can change the settings to show hidden files and folders, as shown below. 

> How can is it possible to write hidden files?
